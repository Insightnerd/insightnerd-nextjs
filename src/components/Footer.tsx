        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-8 lg:gap-16 pb-10 sm:pb-12">
          ...
          <div className="flex flex-col space-y-4 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-2">
              <span className="text-[hsl(28_72%_65%)] text-2xl font-extrabold">
                &lt;/&gt;
              </span>
              <span className="text-foreground text-2xl font-bold">
                Insight<span className="text-[hsl(28_72%_65%)]">Nerd</span>
              </span>
            </div>
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-muted-foreground hover:text-[hsl(28_72%_65%)] transition-colors text-sm"
                    >
                      {link.label}
                    </Link>
                  </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center space-x-3 text-muted-foreground hover:text-[hsl(28_72%_65%)] transition-colors text-sm"
                >
                  <Mail size={16} className="text-[hsl(28_72%_65%)] shrink-0" />
                  <span>Gmail</span>
                </a>
              </li>
              <li>
                <a
                  ...
                  className="flex items-center space-x-3 text-muted-foreground hover:text-[hsl(28_72%_65%)] transition-colors text-sm"
                >
                  <svg viewBox="0 0 24 24" className="h-4 w-4 shrink-0 fill-[hsl(28_72%_65%)]" aria-hidden="true">
